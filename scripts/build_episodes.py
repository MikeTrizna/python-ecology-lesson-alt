...
if __name__ == "__main__":
    ...
    # Restore the original setup file if none found
    path = os.path.join(lesson_root, "learners", "setup.md")
    try:
        open(path)
    except FileNotFoundError:
        shutil.copy2(os.path.join(lesson_root, "learners", "setup.md_orig"), path)
